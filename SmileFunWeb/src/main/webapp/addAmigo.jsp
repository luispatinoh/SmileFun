        ...
        <div class="container">
            <div class="main">
                ...
                <div class="centered" style="width:400px">
                    ...
                    <form method="POST" action='AmigoController' name="frmNuevoAmigo" class="pure-form">
                        <fieldset class="pure-group">
                            <label>Ingrese amigo</label>
                            <br/>
                            <br/>
                            <input type="text" class="pure-input-1-2" placeholder="Amigo" name="amigoId">
                        </fieldset>
